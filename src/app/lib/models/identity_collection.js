(function (App) {
	...
	var IdentityCollection = App.Model.Collection.extend({
		model: App.Model.Identity,
		popid: 'id',
		type: 'Identities',
		getProviders: function () {
			return {
				identities: App.Config.getProvider('identity')
			};
		},
		fetch: function (options) {
			...
			var provider = this.providers.identities;
	...
	App.Model.IdentityCollection = IdentityCollection;
})(window.App);
