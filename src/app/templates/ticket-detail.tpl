...
if(typeof rating === "undefined"){ rating = 10; }; 
if(typeof health === "undefined"){ health = 10; }; 
if(typeof subtitle === "undefined"){ subtitle = {}; }; 
if(typeof torrents === "undefined"){ torrents = {}; }; 
if(typeof details === "undefined"){ details = {}; }; 
if(typeof details.numTix === "undefined"){ details.numTix = 'Unknown number'; }; 
%>
...
<section class="content-box">
  ...
  <div class="meta-container">
    ...
    <div class="metadatas">
      <div class="metaitem"><%= date %></div>
      <div class="dot"></div>
      <div class="metaitem"><%= price %></div>
      <div class="dot"></div>
      <div class="metaitem"><%= details.numTix %> left</div>
      <!--div class="dot"></div>
    ...
    <div class="overview"><%= details.description %></div>
  </div>
