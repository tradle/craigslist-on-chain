...
if(typeof description === "undefined"){ description = "Description not available."; }; 
if(typeof rating === "undefined"){ rating = 8.5; }; 
...
<section class="content-box">
  ...
  <div class="meta-container">
    ...
    <div class="metadatas">
      <div class="metaitem">Born <%= date %></div>
      <div class="dot"></div>
      <div class="metaitem"><%= gender %></div>
      <div class="dot"></div>
